...
<head>
   ...
   <link href="https://fonts.googleapis.com/css?family=Varela+Round" rel="stylesheet">_
...
<body id="page-top" ng-app="LottoApp" ng-controller="HomeCtrl">
         ...
         <div class="row mx-auto text-center">
            <div class="col">
               <div class="row" style="margin-top: 26px;">
                  ...
                  ?>
                  <div class="col">
                     <img class="ball" id="wheel3" ng-class="spin_class" src="./assets/images/wheel.png" />
                     <h2 class="text-red glow" style="margin-top: 8px;"><span style="font-size: 36px; line-height: 16px;"> Current</span><br><b> Number</b></h2>
                     <!--spin content-->

                     <div id="textMachine2" class="result-text ng-binding neon" style="text-align: center;">
                        <div style="color:#FF0000;"><?php echo $data ? $data['number'] : $data['number']; ?></div>
   ...
   <div class="page_wrap">
      ...
      <section class="banner_section">
         <h2 class="banner_heading text-center">Kalkaji Lottery</h2>
      </section>
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="d-flex flex-column text-center">
                     <div class="img_wrap ">
                        <button class="btn btn mb-4 p-3" style="background-color: #00ff0d; color:white">Kalkaji
                           Lottery</button>
                        <div class="img_box">
                           <img class="gift_img" src="./assets/images/matka.png" alt="">
                           <span id="count" data-aos="zoom-in" data-aos-easing="ease" data-aos-duration="1000" style="text-align: center; z-index:1; color: #00ff0d;"><?php echo $data ? $data['number'] : $data['number']; ?></span>
                        </div>
                     </div>
                     <div class="button_grup mt-4">
                        <button class="btn btn-danger p-3" id="clock" style="background-color: #00ff0d; color:white;">
                           11:30 AM
                        </button>
                     </div>
                  </div>
                     ...
                     <table id="table" class="table table-hover">
                        <thead>
                           <tr style="background-color: #FF0000; z-index: 1 ; position: relative;">
                              <th style="background: #00ff0d; ">S.no</th>
                              <th style="background: #00ff0d;">Game</th>
                              <th style="background: #00ff0d;">Time</th>
                              <th style="background: #00ff0d;">Old Number</th>
                              <th style="background: #00ff0d;">New Number</th>
                           </tr>
                        </thead>
                        <tbody>
               ...
               <div class="row justify-content-center">
                  <div class="col-md-2">
                     <form action="" method="" class=" mt-5">
                        ...
                        <button type="button" class="btn btn-danger m-2 p-3" style="background-color: #00ff0d; color:white;" onclick="get_daily_data('monthly', null)">Search</button>
                        <button type="button" class="btn btn-danger m-2 p-3" style="background-color: #00ff0d; color:white;" onclick="get_daily_data('yearly', null)">Search All</button>
                     </form>
                  </div>
               </div>
            </div>
               ...
               <div class="col-md-12" data-aos="fade-up" data-aos-easing="ease" data-aos-delay="200" data-aos-duration="1000">
                  <div class="table_scroll">
                     <table id="table2" class="table table-hover">
                        <thead>
                           <tr>
                              <th style="background: #00ff0d;">Date</th>
                              <th style="background: #00ff0d;">10:00 AM</th>
                              <th style="background: #00ff0d;"> 11:00 AM</th>
                              <th style="background: #00ff0d;"> 12:00 PM</th>
                              <th style="background: #00ff0d;"> 1:00 PM</th>
                              <th style="background: #00ff0d;"> 2:00 PM</th>
                              <th style="background: #00ff0d;"> 3:00 PM</th>
                              <th style="background: #00ff0d;"> 4:00 PM</th>
                              <th style="background: #00ff0d;"> 5:00 PM</th>
                              <th style="background: #00ff0d;"> 6:00 PM</th>
                              <th style="background: #00ff0d;"> 7:00 PM</th>
                              <th style="background: #00ff0d;"> 8:00 PM</th>
                              <th style="background: #00ff0d;"> 9:00 PM</th>
                              <th style="background: #00ff0d;"> 10:00 PM</th>
                              <th style="background: #00ff0d;"> 11:00 PM</th>
   ...
   <script>
      function updateClock() {
         let date = new Date();
         let hours = (date.getHours() + 1) % 12 || 12; // add 1 hour and handle 12-hour clock
         let ampm = (date.getHours() + 1) >= 12 ? 'PM' : 'AM'; // determine AM/PM
